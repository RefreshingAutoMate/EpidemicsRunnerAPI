...
/*
This function evaluates the SEIRDCK model with four coupled regions and writes the output to file.
*/
...
int main(int argc, char *argv[]){
	...
	region_initials.push_back(InitialConditions({239264,1500,0,0,0,0,0},{0, 1e-6},"LK_Main-Taunus-Kreis"));
	region_initials.push_back(InitialConditions({278609,1500,0,0,0,0,0},{0, 1e-6},"SK_Wiesbaden"));	
	
	constexpr int regions=4;
