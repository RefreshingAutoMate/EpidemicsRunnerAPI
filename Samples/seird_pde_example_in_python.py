...
tau = 1;
rho = 0.1;
diffusion=0; #if turned to something not equal to zero, care must be taken
...
model=covpred.SEIRD_VARA(alpha, kappa, theta, sigma,tau,diffusion)
filepath=""
filename="output"
model.set_store_to_file(True,filepath,filename);
'''
